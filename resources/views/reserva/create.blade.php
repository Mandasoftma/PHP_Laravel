        ...
        <div class="col-md-12 col-md-offset-0">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form name="crea" class="form-horizontal" method="POST" action="{{ route('Reservas.store') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('Names') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="Names" type="text" class="form-control" name="Names" value="{{ old('Names') }}" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('NoPersonas') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="NoPersonas" type="number" min="1" max="50" class="form-control" name="NoPersonas" onchange="validanroperonas()" value="{{ old('NoPersonas') }}" required >
                        ...
                        <div id="NBut" style="display:none">0</div>
                                ...
                                <div id="sala" class="col-md-12">
                                    <table class="table sala">
                                        <tbody>
                                            ...
                                            <th scope="row">B</th>
                                                @for ($i = 1; $i < 11; $i++)
                                                <td><input class="form-check-input" type="checkbox" name="Butacas[]" onchange="validaCheck('{{$i}}B')" value="{{$i}}B" id="Check{{$i}}B">{{$i}}B</td>
                                                @endfor
                                            </tr>
                                            <tr>
                                            <th scope="row">C</th>
...
@section('scripts')
    <script type="text/javascript">
        ...
        function dehabilitarCheckbox(){
            ...
            todos=document.crea.getElementsByTagName('input');
            all.forEach(element => {
                for(x=0;x<todos.length;x++){
                    if(document.crea.elements[x].type == "checkbox"){                                                       
                        if (element.Butacas.indexOf(todos[x].value)>-1){
                            ...
                            document.crea.elements[x].disabled = true;
                        }
                    }
                }            				
            });      
